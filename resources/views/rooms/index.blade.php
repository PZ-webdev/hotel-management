        ...
        <div class="container">
          <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
              <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.html">Start</a></span> <span>Pokoje</span></p>
        ...
        <div class="container">
          <div class="row">
              <div class="col-lg-3 sidebar">
                  <div class="sidebar-wrap bg-light ftco-animate">
                      ...
                      <form action="#">
                        ...
                        <div class="form-group">
                          ...
                          <select name="" id="" class="form-control" placeholder="Kategoria">
                        ...
                        <div class="form-group">
                          <input type="text" id="checkin_date" class="form-control" placeholder="Data rozpoczęcia">
                        </div>
                        <div class="form-group">
                          <input type="text" id="checkin_date" class="form-control" placeholder="Data zakończenia">
                        </div>
                        <div class="form-group">
                            <div class="range-slider">
                                <span>
                                              <input type="number" value="250" min="0" max="1200"/>	-
                                              <input type="number" value="500" min="0" max="1200"/>
                                            </span>
                  ...
                  <div class="sidebar-wrap bg-light ftco-animate">
                      <h3 class="heading mb-4">Oceny</h3>
                              ...
                              <div class="destination">
                                  ...
                                  <div class="text p-3">
                                      ...
                                      <p class="bottom-area d-flex">
                                          ...
                                          <span class="ml-auto"><a href="#">Rezerwuj</a></span>
                                      </p>
                                  </div>
                              </div>
                          </div>
