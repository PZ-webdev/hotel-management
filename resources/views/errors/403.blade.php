    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <h3 class="text-uppercase error-subtitle">ZABRONIONO DOSTĘPU !</h3>
                <p class="text-muted mt-4 mb-4">WYDAJE SIĘ, ŻE NIE MASZ UPRAWNIEŃ DO PRZEGLĄDANIA TEJ STRONY</p>
