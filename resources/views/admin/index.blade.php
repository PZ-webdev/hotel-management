            ...
            <div class="col-lg-4 col-md-12">
                <div class="white-box analytics-info">
                    ...
                    <ul class="list-inline two-part d-flex align-items-center mb-0">
                        ...
                        <li class="ms-auto"><span class="counter text-purple">{{ $roomCount }}</span></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-12">
                ...
                <div class="white-box">
                    ...
                    <div class="table-responsive">
                        <table class="table no-wrap">
                            ...
                            <tbody>
                                @foreach ($lastReservations as $reservations)
                                    <tr>
                                        <td>{{ $loop->iteration }}.</td>
                                        <td class="txt-oflo">
                                            {{ $reservations->first_name . ' ' . $reservations->last_name }}</td>
                                        <td>{{ $reservations->date_start }}</td>
                                        <td class="txt-oflo">{{ $reservations->date_end }}</td>
                                        <td><span>{{ $reservations->dateDiffInDays($reservations->date_start, $reservations->date_end) }}</span>
                                        </td>
                                        <td>{{ $reservations->confirm($reservations->verified_at) }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
